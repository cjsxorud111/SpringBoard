		...
		<table class="table">
			...
			<tr>
				...
				<form action="writesub" method="post">
					<td><textarea name="subcon" rows="5" cols="120"></textarea><input
		...
		<table class="table">
			<c:forEach items="${GetSubList}" var="a">
				<tr>
					...
					<%-- <td>${a.num}</td> --%>
					<td><c:forEach begin="0" end="${a.space}">ㅡ</c:forEach>${a.content}
				...
				<tr>
					...
					<form action="writesub" method="post">
						...
						&nbsp&nbspㄴ
							<textarea name="subcon" rows="2" cols="80"></textarea> 
							...
							<input type="submit" value="댓글달기"/> 
	  						<input type="button" id="sub${a.num}" onclick="sub_del(${a.num});" value="댓글취소" />
