        ...
        <div style="float: left;">
            <a href="http://www.helloword.kr/" id="title"
               style="color: white; margin-left: 0.1rem; margin-bottom: 1rem; position: relative; bottom: 10px; font-weight: 200;">
                <div id="logo"
                     style="position: relative; z-index: 100;">HelloWord!
                </div>
                <div
    ...
    <div id='innerSection'
        ...
        <div id="scroll"
            ...
            <div style="background-color: white; box-shadow:4px 4px 1px 1px gray; padding: 10px;">
                <div style="padding-top: 0.7rem; margin-bottom: 1rem; margin-left: 3rem; font-weight: 700;">단어를 정의한
                    회원랭킹
                </div>
                            ...
                            <div id="delete">
                                <div style="float: right;">
                                    <button
                                            ...
                                            class="defineDeleteButton" style="font-weight: 500;">삭제
                                    </button>
                                </div>
                                <div style="float: right;">
