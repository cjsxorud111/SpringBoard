...
//	@Pointcut("within(com.example.controller.*)")	//com.javalec.ex 패키지 안에 있는 모든 메소드
//	@Pointcut("within(com.example.controller..*)")  //com.javalec.ex 패키지 및 하위 패키지 안에 있는 모든 메소드
//	@Pointcut("within(com.javalec.ex.Worker)") //com.javalec.ex.Worker 모든 메소드
//	@Pointcut("bean(student)")	//student 빈에만 적용
//	@Pointcut("bean(*ker)")		//~ker로 끝나는 빈에만 적용execution(public * *(..))
